            ...
            <div class="max-w-4xl mx-auto bg-white p-6 rounded-xl shadow">
                ...
                <form action="{{ route('servicios.update', $servicio->id) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="iva_aplicable" class="block text-sm font-medium text-gray-700 mb-1">
                                IVA aplicable
                            </label>
                            <select name="iva_aplicable"
                                    id="iva_aplicable"
                                    class="w-full rounded-lg border-gray-300 text-sm
                                           focus:ring-gray-900 focus:border-gray-900">
                                <option value="1" {{ old('iva_aplicable', $servicio->iva_aplicable) == 1 ? 'selected' : '' }}>
                                    Sí
                                </option>
                                <option value="0" {{ old('iva_aplicable', $servicio->iva_aplicable) == 0 ? 'selected' : '' }}>
                                    No
                                </option>
                            </select>
                        </div>
                    ...
                    <div>
                        ...
                        <textarea name="descripcion"
                                  ...
                                  rows="3"
                                  class="w-full rounded-lg border-gray-300 text-sm
                                         focus:ring-gray-900 focus:border-gray-900">{{ old('descripcion', $servicio->descripcion) }}</textarea>
                    </div>
