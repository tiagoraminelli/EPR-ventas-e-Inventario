            ...
            <form action="{{ route('servicios.update', $servicio->id) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="iva_aplicable" id="iva_aplicable"
                            class="w-full rounded-md border border-gray-300 shadow-sm p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
                            required>
                            <option value="1" {{ old('iva_aplicable', $servicio->iva_aplicable) == 1 ? 'selected' : '' }}>Sí</option>
                            <option value="0" {{ old('iva_aplicable', $servicio->iva_aplicable) == 0 ? 'selected' : '' }}>No</option>
                        </select>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="descripcion" id="descripcion" rows="3"
                        class="w-full rounded-md border border-gray-300 shadow-sm p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300">{{ old('descripcion', $servicio->descripcion) }}</textarea>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="precio" class="block text-sm font-semibold text-gray-700 mb-1">Precio ($)</label>
                        <input type="number" name="precio" id="precio" step="0.01" value="{{ old('precio', $servicio->precio) }}"
                            class="w-full rounded-md border border-gray-300 shadow-sm p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
                            required>
                    </div>
                    <div>
                        ...
                        <select name="activo" id="activo"
                            class="w-full rounded-md border border-gray-300 shadow-sm p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
                            required>
                            <option value="1" {{ old('activo', $servicio->activo) == 1 ? 'selected' : '' }}>Sí</option>
                            <option value="0" {{ old('activo', $servicio->activo) == 0 ? 'selected' : '' }}>No</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="visible" id="visible"
                            class="w-full rounded-md border border-gray-300 shadow-sm p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
                            required>
                            <option value="1" {{ old('visible', $servicio->visible) == 1 ? 'selected' : '' }}>Sí</option>
                            <option value="0" {{ old('visible', $servicio->visible) == 0 ? 'selected' : '' }}>No</option>
                        </select>
                    </div>
                </div>
