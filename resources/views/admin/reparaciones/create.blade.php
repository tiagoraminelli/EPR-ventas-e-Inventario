    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 container mx-auto bg-white p-8 rounded-xl shadow-lg">
            <div class="flex justify-between items-center mb-6 border-b pb-4">
                <h1 class="text-3xl font-bold text-gray-800">Crear Nueva Reparación</h1>
            ...
            <form action="{{ route('reparaciones.store') }}" method="POST" class="space-y-6">
                @csrf

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="codigo_unico" class="block text-sm font-semibold text-gray-700 mb-1">Código
                            Único</label>
                        <input type="text" name="codigo_unico" id="codigo_unico" value="{{ old('codigo_unico') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="equipo_descripcion" class="block text-sm font-semibold text-gray-700 mb-1">Descripción
                            del Equipo</label>
                    ...
                    <div>
                        <label for="equipo_marca" class="block text-sm font-semibold text-gray-700 mb-1">Marca del
                            Equipo</label>
                        <input type="text" name="equipo_marca" id="equipo_marca" value="{{ old('equipo_marca') }}"
                            class="w-full rounded-md border border-gray-300 shadow-sm p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
                            required>
                    </div>
                    <div>
                        <label for="equipo_modelo" class="block text-sm font-semibold text-gray-700 mb-1">Modelo del
                            Equipo</label>
                        <input type="text" name="equipo_modelo" id="equipo_modelo" value="{{ old('equipo_modelo') }}"
                            class="w-full rounded-md border border-gray-300 shadow-sm p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
                            required>
                    </div>
                    <div>
                ...
                <div>
                    <label for="descripcion_danio" class="block text-sm font-semibold text-gray-700 mb-1">Descripción
                        del Daño</label>
                ...
                <div>
                    <label for="solucion_aplicada" class="block text-sm font-semibold text-gray-700 mb-1">Solución
                        Aplicada</label>
                    <textarea name="solucion_aplicada" id="solucion_aplicada" rows="3"
                        class="w-full rounded-md border border-gray-300 shadow-sm p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300">{{ old('solucion_aplicada') }}</textarea>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="estado_reparacion" class="block text-sm font-semibold text-gray-700 mb-1">Estado de
                            la Reparación</label>
                    ...
                    <div>
                        <label for="fecha_ingreso" class="block text-sm font-semibold text-gray-700 mb-1">Fecha de
                            Ingreso</label>
