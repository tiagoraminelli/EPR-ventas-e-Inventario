        ...
        <main class="flex-1 p-6">
            <div class="max-w-7xl mx-auto bg-white rounded-lg shadow p-6">
                ...
                <div class="flex justify-between items-center mb-6 border-b pb-3">
                    <div>
                        <h1 class="text-xl font-semibold text-gray-800">Crear Nueva Venta</h1>
                        <p class="text-xs text-gray-500 mt-0.5">Complete la información requerida para registrar una
                            nueva venta</p>
                    </div>
                ...
                <form action="{{ route('ventas.store') }}" method="POST" id="venta-form" class="space-y-6">
                    @csrf

                    <!-- Información general -->
                    <div class="bg-white border rounded-lg overflow-hidden">
                        <div class="px-4 py-3 bg-gray-50 border-b border-gray-200">
                            <h2 class="text-sm font-semibold text-gray-700 uppercase tracking-wider">Información de la
                                Venta</h2>
                        </div>
                        <div class="p-5 grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="observaciones" id="observaciones" rows="2" class="w-full border rounded px-3 py-2 text-sm">{{ old('observaciones') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white border rounded-lg overflow-hidden">
                        <div class="px-4 py-3 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
                            <div>
                                <h2 class="text-sm font-semibold text-gray-700 uppercase tracking-wider">Productos del
                                    Detalle</h2>
                            ...
                            <table id="productos-table" class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">
                                            Precio Unit.</th>
                                        <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Dto
                                            %</th>
                                        <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">
                                            Subtotal</th>
                                        <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">
                    ...
                    <div class="bg-white border rounded-lg overflow-hidden">
                        <div class="px-4 py-3 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
                            <div>
                                <h2 class="text-sm font-semibold text-gray-700 uppercase tracking-wider">Servicios del
                                    Detalle</h2>
                    ...
                    <div class="bg-white border rounded-lg overflow-hidden">
                        <div class="px-4 py-3 bg-gray-50 border-b border-gray-200">
                            <h2 class="text-sm font-semibold text-gray-700 uppercase tracking-wider">Resumen de Totales
                            </h2>
                        </div>
                        <div class="p-5 grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="bg-gray-50 p-3 rounded border">
                                <span class="block text-xs text-gray-600 uppercase font-medium">Importe Neto</span>
                                <p id="importe-neto" class="text-lg font-bold text-gray-900">$0.00</p>
                            ...
                            <div class="bg-gray-50 p-3 rounded border">
                                ...
                                <p id="importe-iva" class="text-lg font-bold text-gray-900">$0.00</p>
                            ...
                            <div class="bg-blue-50 p-3 rounded border border-blue-200">
                                ...
                                <p id="importe-total" class="text-lg font-bold text-blue-800">$0.00</p>
    ...
    <script>
        (function() {
            ...
            $(document).ready(function() {
                ...
                // ✅ NO se agregan filas automáticamente al inicio
                // El formulario comienza sin productos ni servicios
            ...
            function addRow(type) {
                ...
                const data = isProduct ? state.productos : state.servicios;
                const index = isProduct ? state.productoIndex++ : state.servicioIndex++;

                // ✅ ELIMINADO: Validación de límite máximo de productos/servicios
                // Ahora se pueden agregar productos aunque ya estén todos seleccionados
            ...
            function generateRowHtml(type, index) {
                ...
                if (isProduct) {
                    return `<tr class="detalle-producto-row">
                        ...
                        <td class="px-3 py-2 whitespace-nowrap subtotal-cell font-medium text-sm">$0.00
                            <input type="hidden" name="productos[${index}][subtotal]" class="subtotal-input" value="0">
                        </td>
                        <td class="px-3 py-2 whitespace-nowrap">
                            <input type="text" name="productos[${index}][subcategoria]" class="subcategoria-field w-24 border rounded px-2 py-1.5 bg-gray-50 text-sm" disabled>
                        </td>
                        <td class="px-3 py-2 whitespace-nowrap">
                            <input type="text" name="productos[${index}][marca]" class="marca-field w-24 border rounded px-2 py-1.5 bg-gray-50 text-sm" disabled>
                        </td>
                        <td class="px-3 py-2 whitespace-nowrap">
                            <input type="text" name="productos[${index}][stock]" class="stock-field w-16 border rounded px-2 py-1.5 bg-gray-50 text-sm" disabled>
                        </td>
            ...
            $(document).on('click', '.btn-eliminar', function() {
                ...
                // ✅ ELIMINADO: Validación que exigía al menos un elemento
                // Ahora se pueden eliminar todas las filas
            ...
            function validateForm() {
                ...
                // ✅ ELIMINADO: Validación que exigía al menos un producto o servicio
                // Ahora se puede guardar una venta sin productos ni servicios
                ...
                $('.detalle-producto-row').each(function(index) {
                    ...
                    /* Validar stock, cambiar en caso que se desee*/
            ...
            function handleSubmit(e) {
                ...
                $btn.prop('disabled', true).text('Guardando...').removeClass('bg-blue-600 hover:bg-blue-700').addClass(
                    'bg-blue-400');
                return true;
            }
            ...
            function clearForm() {
                if (confirm('¿Está seguro de que desea limpiar todo el formulario?')) {
                    ...
                    // ✅ ELIMINADO: No se agregan filas automáticamente al limpiar
                    calculateTotals();
                }
            }
        })();
