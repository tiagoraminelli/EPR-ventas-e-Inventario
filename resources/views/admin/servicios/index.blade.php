        ...
        <main class="flex-1 p-6">
            <div class="max-w-7xl mx-auto bg-white p-6 rounded-xl shadow">
                ...
                <form action="{{ route('servicios.index') }}" method="GET"
                    class="mb-6 flex flex-col lg:flex-row gap-3">
                    ...
                    <select name="activo"
                        class="rounded-lg border-gray-300 text-sm focus:ring-gray-800 focus:border-gray-800">
                    ...
                    <button type="submit"
                        class="inline-flex items-center justify-center gap-2 px-4 py-2 bg-gray-900 text-white text-sm rounded-lg hover:bg-gray-800 transition">
                    ...
                    <table class="min-w-full bg-white text-sm">
                        <thead class="bg-gray-50 border-b">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-center font-semibold text-gray-600">IVA</th>
                                <th class="px-6 py-3 text-center font-semibold text-gray-600">Precio</th>
