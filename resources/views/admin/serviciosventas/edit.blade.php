        ...
        <div class="bg-white p-6 shadow">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                <h1 class="text-2xl font-semibold">
                    Editar Servicios de Venta #{{ $venta->id }}
                </h1>
            ...
            <form action="{{ route('serviciosventas.update', $venta) }}" method="POST" id="editServiciosVentasForm">
                @csrf
                @method('PUT')
                    ...
                    <div class="border border-gray-200 p-4 bg-gray-50">
                        ...
                        <div class="text-sm space-y-1 text-gray-700">
                            <p><span class="font-medium">Fecha:</span>
                                {{ \Carbon\Carbon::parse($venta->fecha_venta)->format('d/m/Y') }}</p>
                            <p><span class="font-medium">Tipo:</span> {{ $venta->tipo_comprobante }}</p>
                            <p><span class="font-medium">Condición:</span> {{ $venta->condicion_pago }}</p>
                            <p><span class="font-medium">N° Comprobante:</span> {{ $venta->numero_comprobante }}</p>
                            <p><span class="font-medium">Estado:</span> {{ $venta->estado_venta }}</p>
                        </div>
                    </div>
                                    ...
                                    <tr class="hover:bg-gray-50 service-row">
                                        ...
                                        <td class="px-4 py-2 text-center">
                                            <input type="text"
                                                   ...
                                                   value="{{ $sv->servicio->activo ? 'Sí' : 'No' }}"
                                                   disabled>
                                        </td>
